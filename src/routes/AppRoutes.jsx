...
import ResearchDashboard from "../modules/Hearing_and_Research/pages/ResearchDashboard";
import Hearings from "../modules/Hearing_and_Research/pages/Hearings"; // ✅ NEW
...
function RoleRedirect() {
  ...
  if (role === "RESEARCHER") {
    return <Navigate to="/research" replace />; // ✅ SAFE
  }

  if (role === "COURT_CLERK") {
    return <Navigate to="/hearing-dashboard" replace />; // ✅ NEW
  }
...
export default function AppRoutes({ ProtectedRoute, isAuthenticated }) {
  return (
    <Routes>
      ...
      {/* ✅ RESEARCH MODULE (UNCHANGED ✅ SAFE) */}
      <Route path="/research" element={<DashboardLayout />}>
        <Route index element={<ResearchDashboard />} />
      </Route>

      {/* ✅ ✅ NEW HEARING MODULE */}
      <Route path="/hearing-dashboard" element={<DashboardLayout />}>
        <Route index element={<Hearings />} />
      </Route>
