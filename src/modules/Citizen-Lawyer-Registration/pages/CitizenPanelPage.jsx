...
export default function CitizenPanelPage() {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      <div className="rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200 sm:flex sm:items-center sm:justify-between">
        <div>
          ...
          <h4 className="text-2xl font-semibold text-slate-900">Citizen Panel</h4>
          <p className="mt-2 text-sm text-slate-500">View, manage and update registered citizens and their documents in a clean portal.</p>
        </div>
