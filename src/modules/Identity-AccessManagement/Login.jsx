...
//       } else if (data.role === "COURT_CLERK") {
//         navigate("/hearing-dashboard"); // ✅ NEW
      ...
      >
        ...
        <div className="card-body p-4 p-md-5">
          ...
          <div className="text-center mt-4">
            ...
            <Link
              to="/"
              className="text-secondary text-decoration-none small d-flex align-items-center justify-content-center"
            >
