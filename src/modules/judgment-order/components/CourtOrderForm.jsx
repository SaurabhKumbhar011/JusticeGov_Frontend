...
const ORDER_STATUS_OPTIONS = ["DRAFT", "ISSUED", "COMPLIED", "NON_COMPLIANT"];

export default function CourtOrderForm({
  selected,
  defaultCaseId,
  onCreate,
  onUpdate,
  ...
  return (
    <div className="modal fade" id="courtOrderModal" tabIndex="-1" aria-hidden="true">
        ...
        <div className="modal-content border-0 shadow-lg rounded-4">
          ...
          <div className="modal-header border-bottom-0 pt-4 px-4 pb-2">
            <div>
              <h5 className="modal-title fw-bold fs-4 text-dark">
                {selected ? "Update Court Order" : "Issue New Court Order"}
              </h5>
              <p className="text-muted small mb-0">Specify the directives and compliance status for this order.</p>
            </div>
          ...
          <div className="modal-body px-4 py-3">
            <div className="row g-4">
              ...
              <div className="col-md-6">
                <label className="form-label fw-semibold text-secondary small text-uppercase">Compliance Status</label>
                <select
              ...
              <div className="col-md-12">
                <label className="form-label fw-semibold text-secondary small text-uppercase">Effective Date</label>
                <input
                  type="date"
              ...
              <div className="col-12">
                <label className="form-label fw-semibold text-secondary small text-uppercase">Order Description</label>
                <textarea
                  className="form-control bg-light-focus"
                  name="description"
                  rows={4}
                  placeholder="Enter specific instructions or requirements of the order..."
          ...
          <div className="modal-footer border-top-0 px-4 pb-4 pt-2">
            ...
            <button
              ...
              data-bs-dismiss="modal"
            >
              {selected ? "Update Order" : "Create Order"}
            </button>
          </div>
        </div>
      </div>
