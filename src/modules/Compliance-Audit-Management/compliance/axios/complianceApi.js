...
export const getAllComplianceRecords = async () =>
    api.get('http://localhost:8086/api/compliance/records');

// GET    /api/compliance/records/{id}
export const getComplianceRecordById = async (id) =>
    api.get(`http://localhost:8086/api/compliance/records/${id}`);
...
export const getComplianceResultCount = async (result, start, end) =>
    api.get(`http://localhost:8086/api/compliance/result-count?result=${result}&start=${start}&end=${end}`);